                            ...
                            <article class="col col69 contents mcol100">
                                ...
                                <div class="recruit-content">
                                    ...
                                    <c:forEach items="${requestScope.listRecDetail}" var="list">
                                        <li class="mcol100">
                                            <h3><a title="Lập trình viên Java" class="title-urgent" href="http://localhost:8084/baitap/recruitment/<c:out value="${list.id}"></c:out>"><c:out value="${list.name}"></c:out>
                                ...
                                <a href="http://localhost:8084/baitap/recruitment" title="Xem tất cả" class="viewall textcenter">Xem tất cả</a>
                            </div>
                            <!--End contentnewslist-->
                        </article>
                        <!--End contents-->
